...
import BumpWithOtherExtensions from "./pages/BumpWithOtherExtensions";
...
const router = createMemoryRouter([
  {
    ...
    children: [
      ...
      {
        path: "/bump",
        element: <BumpWithOtherExtensions />,
      },
    ],
  },
]);
...
function App() {
  ...
  if (state === undefined) {
    ...
    return <BumpWithOtherExtensions />;
  }
